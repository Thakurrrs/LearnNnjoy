...
export default function Home() {
  ...
  function applySavedProgress(saved: Partial<SavedProgress>) {
    ...
    if (saved.activeSubject === "maths" || ((saved.activeSubject === "science" || saved.activeSubject === "english" || saved.activeSubject === "social") && (saved.grade === 4 || saved.grade === 5 || saved.grade === 6 || saved.grade === 7 || saved.grade === 8 || saved.grade === 9))) setActiveSubject(saved.activeSubject);
  ...
  const isScienceMission = activeSubject === "science" && grade <= 9;
  const isEnglishMission = activeSubject === "english" && grade <= 9;
  const isSocialMission = activeSubject === "social" && grade <= 9;
