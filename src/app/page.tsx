...
export default function Home() {
  ...
  function applySavedProgress(saved: Partial<SavedProgress>) {
    ...
    if (saved.activeSubject === "maths" || ((saved.activeSubject === "science" || saved.activeSubject === "english" || saved.activeSubject === "social") && (saved.grade === 4 || saved.grade === 5))) setActiveSubject(saved.activeSubject);
  ...
  const isScienceMission = activeSubject === "science" && grade <= 5;
  const isEnglishMission = activeSubject === "english" && grade <= 5;
  const isSocialMission = activeSubject === "social" && grade <= 5;
