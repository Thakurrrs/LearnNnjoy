...
export type VisualKind = "fraction" | "number-line" | "ratio" | "formula" | "coordinate" | "ecosystem";
...
export type Question = {
  ...
  explanation: string;
  visual: VisualKind;
  skill: "fractions" | "number-sense" | "proportion" | "algebra" | "geometry" | "data" | "science-inquiry";
};
