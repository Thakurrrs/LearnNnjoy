...
export const gradeQuestArc: Record<Grade, Question[]> = {
  ...
  7: [
    item("g7-1", "Nova's mountain camp shows −3°C at dawn. The sun warms it by 8°C. What does it show now?", ["5°C", "−5°C", "11°C"], "5°C", "Start at −3. Climb 8 steps up the scale. Where do you land?", "−3 + 8 = 5. Climbing 8 from −3 crosses zero and lands on 5.", "number-line", "fractions"),
    item("g7-2", "Nova's star-crate lock says: x + 5 = 12. What is x?", ["7", "17", "5"], "7", "Take 5 away from BOTH sides. What stays with x?", "x + 5 = 12 means x = 12 − 5 = 7. Both sides stayed fair.", "formula", "fractions"),
    item("g7-3", "The ₹240 expedition kit has 25% off. How many rupees does Nova save?", ["₹60", "₹25", "₹180"], "₹60", "25% means one quarter. Split ₹240 into 4 equal parts.", "25% = 1/4. ₹240 ÷ 4 = ₹60 saved, so the kit costs ₹180.", "fraction", "number-sense"),
    item("g7-4", "Which number sits between −2 and −3 on Nova's trail?", ["−2.5", "−1.5", "−3.5"], "−2.5", "Between −2 and −3 means past −2 but not past −3.", "−2.5 lies halfway between −2 and −3 on the number line.", "number-line", "number-sense"),
