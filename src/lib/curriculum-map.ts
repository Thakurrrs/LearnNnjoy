...
export const curriculumMap: Record<Grade, GradeRoadmap> = {
  ...
  5: {
    ...
    science: entry("science", "EVS", "🌿", "Earthkeepers", ["Living systems and health", "Materials, water and work", "People, places and sustainability"], "mapped"),
    social: entry("social", "Our World", "🧭", "Mapmakers' Camp", ["India's regions and communities", "Maps and journeys", "Rights, responsibilities and resources"], "mapped"),
    english: entry("english", "English", "📚", "Story Studio", ["Comprehension and inference", "Grammar in context", "Narrative and informative writing"], "mapped"),
  },
  6: {
    ...
    science: entry("science", "Science", "🔬", "Discovery Lab", ["Food, materials and living things", "Motion, light and electricity", "Earth, water and our environment"], "mapped"),
    social: entry("social", "Social Science", "🧭", "Chronicle Quest", ["Early societies and history", "Earth, maps and livelihoods", "Government and diversity"], "mapped"),
    english: entry("english", "English", "📚", "Story Studio", ["Close reading and response", "Language for expression", "Creative and purposeful writing"], "mapped"),
  },
  7: {
  ...
  8: {
    maths: entry("maths", "Mathematics", "✦", "Lumina Restoration", ["Rational numbers and exponents", "Linear equations, percentage and graphs", "Geometry, mensuration and probability"], "mapped"),
  ...
  9: {
    maths: entry("maths", "Mathematics", "✦", "Orbit Academy", ["Number systems and algebra", "Coordinate geometry and linear equations", "Geometry, statistics and probability"], "mapped"),
  ...
  10: {
    maths: entry("maths", "Mathematics", "✦", "Orbit Academy", ["Real numbers, polynomials and equations", "Trigonometry and coordinate geometry", "Mensuration, statistics and probability"], "mapped"),
  ...
  11: {
    maths: entry("maths", "Mathematics", "✦", "Orbit Academy", ["Sets, functions and trigonometry", "Complex numbers and coordinate geometry", "Calculus foundations, probability and statistics"], "mapped"),
  ...
  12: {
    maths: entry("maths", "Mathematics", "✦", "Orbit Academy", ["Relations, functions and calculus", "Vectors, matrices and three-dimensional geometry", "Probability, linear programming and applications"], "mapped"),
