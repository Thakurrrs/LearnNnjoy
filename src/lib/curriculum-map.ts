...
export const curriculumMap: Record<Grade, GradeRoadmap> = {
  ...
  8: {
    ...
    science: entry("science", "Science", "🔬", "Discovery Lab", ["Crop systems, microbes and health", "Force, pressure, sound and light", "Cells, adolescence and conservation"], "live"),
    social: entry("social", "Social Science", "🧭", "Chronicle Quest", ["Colonial history and the Constitution", "Resources, industries and agriculture", "Justice and public institutions"], "live"),
    english: entry("english", "English", "📚", "Story Studio", ["Reading across genres", "Grammar for clarity", "Research, reports and creative writing"], "live"),
  },
  9: {
    ...
    science: entry("science", "Science", "🔬", "Discovery Lab", ["Matter, atoms and the cell", "Motion, force and gravitation", "Life, health and natural resources"], "live"),
    social: entry("social", "Social Science", "🧭", "Chronicle Quest", ["Contemporary history and democracy", "India's geography and economy", "Rights and constitutional design"], "live"),
    english: entry("english", "English", "📚", "Story Studio", ["Critical reading", "Language and literary craft", "Analytical and creative writing"], "live"),
  },
  10: {
    ...
    science: entry("science", "Science", "🔬", "Discovery Lab", ["Chemical reactions and carbon", "Life processes and heredity", "Light, electricity and environment"], "live"),
    social: entry("social", "Social Science", "🧭", "Chronicle Quest", ["Modern India and the world", "Resources, development and economy", "Democracy, power and gender"], "live"),
    english: entry("english", "English", "📚", "Story Studio", ["Literature and evidence", "Grammar in authentic use", "Exam-ready writing and speaking"], "live"),
  },
  11: {
  ...
  12: {
    ...
    science: entry("science", "Science", "🔬", "Discovery Lab", ["Physics, chemistry and biology pathways", "Practical investigation", "Exam and career-linked applications"], "live"),
    social: entry("social", "Social Science", "🧭", "Chronicle Quest", ["Politics, society and global change", "Economics and public policy", "Evidence-based historical and geographic thinking"], "live"),
    english: entry("english", "English", "📚", "Story Studio", ["Literature, voice and context", "Argument and synthesis", "Writing for higher education and work"], "live"),
  },
};
